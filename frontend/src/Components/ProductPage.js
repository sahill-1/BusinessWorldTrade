    ...
    <div className="product-page">
      ...
      <div className="product-details">
        ...
        <div className="key-features">
          <h3>Key Features:</h3>
          <ul style={{border:"1px solid transparent", width:"50%", margin:"auto"}}>
      ...
      <div className="my-4 product-highlights" style={{width:"90%",margin:"auto", textAlign:"left"}}>
        ...
        <div className="customer-reviews" style={{width:"90%",margin:"auto", textAlign:"left"}}>
